...
export async function PUT(request: NextRequest) {
  try {
    // ใช้ auth helper ตัวเดียวกับ GET
    const authResult = await getAuthenticatedUser();
