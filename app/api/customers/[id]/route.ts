...
export async function GET(
  ...
  const accessCheck = await requireCustomerAccess(id, session);
...
export async function PATCH(
  ...
  if (body.bank_code !== undefined) {
    updateData.bank_code = body.bank_code || null;
  }
  ...
  if (body.credit_balance !== undefined) {
    updateData.credit_balance =
      Number(body.credit_balance) || 0;
  }

  // Agent fields
  if (body.agent_level !== undefined) {
    updateData.agent_level = body.agent_level;
  }

  if (body.upline_id !== undefined) {
    updateData.upline_id = body.upline_id || null;
  }
  ...
  if (body.is_partner !== undefined) {
    updateData.is_partner = body.is_partner;
  }
