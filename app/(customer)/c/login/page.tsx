...
export default function CustomerLoginPage() {
  ...
  return (
    <div 
      className="min-h-screen bg-black flex flex-col premium-bg-pattern" 
      style={{ 
    ...
    >
      ...
      <div className="relative flex-shrink-0 z-10">
        <div className="relative px-6 pt-10 pb-6 text-center">
            ...
            <div className="relative">
              ...
              {siteSettings?.logo_url ? (
                <img
                  ...
                  className="relative h-[90px] w-auto drop-shadow-[0_0_25px_rgba(255,215,0,0.6)]"
                />
              ) : (
                <Image
                  ...
                  width={200}
                  height={90}
                  className="relative drop-shadow-[0_0_25px_rgba(255,215,0,0.6)]"
                  priority
                />
              )}
            </div>
          ...
          <p className="text-neutral-400 text-sm mb-2">ระบบหวยออนไลน์ที่ดีที่สุด</p>
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/20">
            ...
            <p className="text-amber-400 text-xs font-medium">จ่ายจริง โอนไว มั่นคง 100%</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 px-6 pb-8 z-10">
        ...
        <div className="premium-card p-6 glow-pulse">
          {/* Form Header */}
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="relative group">
              <div className="absolute left-4 top-1/2 -translate-y-1/2 text-amber-500 transition-all group-focus-within:text-amber-400">
              ...
              <input
                ...
                className="input-premium w-full h-14 pl-12 pr-4 text-white placeholder:text-neutral-500"
              />
            </div>
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="input-premium w-full h-14 pl-12 pr-12 text-white placeholder:text-neutral-500"
              />
              <button
                type="button"
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/c/forgot-password" className="text-sm text-amber-400 hover:text-amber-300 transition-colors hover:underline">
                ลืมรหัสผ่าน?
              </Link>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="btn-luxury w-full h-14 rounded-xl text-lg disabled:opacity-70 relative overflow-hidden"
            >
              {isLoading ? (
          ...
          <div className="flex gap-3">
            <button className="flex-1 h-12 rounded-xl bg-neutral-800/80 border border-neutral-700 flex items-center justify-center gap-2 text-white hover:bg-neutral-700 hover:border-neutral-600 transition-all hover:scale-[1.02]">
            ...
            <button className="flex-1 h-12 rounded-xl bg-[#00B900] flex items-center justify-center gap-2 text-white hover:bg-[#00A000] transition-all hover:scale-[1.02]">
        ...
        <div className="text-center mt-6">
          ...
          <Link href="/c/register" className="text-amber-400 font-semibold hover:text-amber-300 transition-colors hover:underline">
            สมัครสมาชิก
          </Link>
        </div>
      </div>
