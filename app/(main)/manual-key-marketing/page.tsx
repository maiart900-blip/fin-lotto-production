...
export default function ManualKeyMarketingPage() {
  const { data, mutate, isLoading } = useSWR('/api/marketing/stats?type=manual', fetcher);
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-1">จัดการการตลาดและแคมเปญสำหรับระบบคีย์หวย</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link href="/manual-key-marketing/campaigns">
        ...
        <Link href="/manual-key-marketing/links">
          <Card className="bg-black/40 border-[#D4AF37]/20 hover:border-[#D4AF37]/50 transition-all cursor-pointer h-full">
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
        ...
        <Link href="/manual-key-marketing/report">
          <Card className="bg-black/40 border-[#D4AF37]/20 hover:border-[#D4AF37]/50 transition-all cursor-pointer h-full">
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
