...
export default function AutoMarketingReportPage() {
  const { data, mutate, isLoading } = useSWR('/api/marketing/report?type=auto', fetcher);
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white flex items-center gap-2"><BarChart3 className="size-6 text-[#D4AF37]" />รายงานการตลาดออโต้</h1>
